...
<html lang="en">
	<head>
		<title>So Freo - So Vegan, So Good</title>
		<?php 
		$meta = 'Freo Cuisine focuses on providing fresh, healthy, organic, vegan and gluten free options handmade in Australia.';
    ...
    <body>
        ...
        <main>
            ...
            <section class="page-section clearfix">
                <div class="container">
                    <div class="intro">
                        <div class="intro-text left-0 text-center p-4 pb-5 rounded order-md-2 animated no-animation wow fadeInRight">
                          ...
                          <p class="mb-3">So Freo is locally based in Fremantle and focuses on organic and locally sourced ingredients from WA. 
  ...
  <section class="page-section cta mt-4">
    <div class="container">
      <div class="row ">
        <div class="col-xl-9 mx-auto">
          <div class="text-center cta-inner rounded animated no-animation wow fadeInUp">
            ...
            <a class="mb-4">Vegan or not, Gluten intolerant or not, young or old, the Veggie Paté is for you.
            <br>When we prepared the recipe, we had in mind it has to be good AND nutritious. We wanted to add the best in it, organic veggies, a yummy taste and a lot of love! 
            <br>We created some <a href="products.php" class="font-weight-bold">ideas to inspire you</a>, feel free to share with us your way.
            <br>Have a look on our calendar to <a href="stockists.php" class="font-weight-bold">meet us at the market</a> or on the map to find the <a href="stockists.php" class="font-weight-bold">nearest stockist</a>.
