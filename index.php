                ...
                <div class="container">
                    <div class="intro">
                        <div class="intro-text left-0 text-center p-4 pb-5 rounded order-md-2 animated no-animation wow fadeInRight">
                          ...
                          <p class="mb-3">So Freo is based in Fremantle and focuses on organic and locally sourced ingredients from WA. 
                          <br>For school lunch, picnic, plancha or your next outdoor adventure.   
                          <br>Vegan, High Protein & Gluten Free, <br>it ticks all the boxes.
                          </p>
